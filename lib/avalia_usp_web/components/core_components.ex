defmodule AvaliaUspWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AvaliaUspWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AvaliaUspWeb.Gettext, "errors", msg, opts)
    end
  end
